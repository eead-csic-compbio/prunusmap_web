...
class Bmap(object):
    ...
    def __check_input_query(self, input_lines):
        ...
        if input_lines[0].startswith(">"):
            if action == ALIGN_ACTION or action == PROT_ACTION:
                ...
                if num_queries > max_queries:
                    ...
                    raise m2pException("The web application only accepts currently "+str(max_queries)+" in the alig/prot modes.\
